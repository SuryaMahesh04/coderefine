...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Account created — auto-sign them in
      ...
      <main className="relative min-h-[calc(100vh-80px)] mt-20 flex flex-col items-center justify-center p-4">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="text-center mb-10 animate-fade-in-up">
            ...
            <p className="text-zinc-400">Start refining your codebase in seconds</p>
          </div>
          ...
          <div className="bg-zinc-950/80 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-zinc-950 px-3 text-zinc-500 font-medium">OR SIGN UP WITH EMAIL</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1 text-sm font-medium">
                <label className="text-zinc-300 ml-1">Full Name</label>
                <input
                  type="text"
                  required
              ...
              <div className="space-y-1 text-sm font-medium">
                <label className="text-zinc-300 ml-1">Password</label>
                <input
                  type="password"
                  required
                  placeholder="••••••••"
                ...
                />
                <p className="text-[10px] text-zinc-500 ml-1 mt-1">Must be at least 8 characters.</p>
              </div>
          ...
          <p className="text-center mt-6 text-sm text-zinc-500 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            ...
            <Link href="/login" className="text-white hover:text-[#00E5FF] transition-colors font-medium">
              Sign in
            </Link>
          </p>
        </div>
